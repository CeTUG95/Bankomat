/********************************************************************************
** Form generated from reading UI file 'erster_schritt.ui'
**
...
#ifndef UI_ERSTER_SCHRITT_H
#define UI_ERSTER_SCHRITT_H
...
public:
    ...
    void setupUi(QMainWindow *erster_schritt)
    {
        if (erster_schritt->objectName().isEmpty())
            erster_schritt->setObjectName(QStringLiteral("erster_schritt"));
        erster_schritt->resize(1300, 800);
        frame = new QFrame(erster_schritt);
...
"background-color: rgb(230, 230, 230)"));
        ...
        erster_schritt->setCentralWidget(frame);
        frame_2 = new QFrame(erster_schritt);
        ...
        erster_schritt->setCentralWidget(frame_2);
        Kartenleser = new QPushButton(erster_schritt);
...
"border-style: solid;\n"
"border-color: black;"));
        erster_schritt->setCentralWidget(Kartenleser);
        ausgabe = new QLabel(erster_schritt);
...
"border-color: black;"));
        ...
        erster_schritt->setCentralWidget(ausgabe);
        frame_3 = new QFrame(erster_schritt);
        ...
        erster_schritt->setCentralWidget(frame_3);
        frame_4 = new QFrame(erster_schritt);
        ...
        erster_schritt->setCentralWidget(frame_4);
        pushButton_10 = new QPushButton(erster_schritt);
        ...
        erster_schritt->setCentralWidget(pushButton_10);
        HILFE_BUTTON = new QPushButton(erster_schritt);
...
"background-color:rgb(15, 98, 19)"));
        erster_schritt->setCentralWidget(HILFE_BUTTON);
        frame_Auszahlung = new QFrame(erster_schritt);
        ...
        erster_schritt->setCentralWidget(frame_Auszahlung);
        Ausgabe_Einzahlungsbetrag = new QLabel(erster_schritt);
...
"border-style: solid;\n"
"border-color: black;"));
        erster_schritt->setCentralWidget(Ausgabe_Einzahlungsbetrag);

        retranslateUi(erster_schritt);

        QMetaObject::connectSlotsByName(erster_schritt);
    } // setupUi

    void retranslateUi(QMainWindow *erster_schritt)
    {
        erster_schritt->setWindowTitle(QApplication::translate("erster_schritt", "Bankautomat", nullptr));
        pushButton_7->setText(QApplication::translate("erster_schritt", "7", nullptr));
        pushButton_9->setText(QApplication::translate("erster_schritt", "9", nullptr));
        pushButton_8->setText(QApplication::translate("erster_schritt", "8", nullptr));
        pushButton_4->setText(QApplication::translate("erster_schritt", "4", nullptr));
        pushButton_6->setText(QApplication::translate("erster_schritt", "6", nullptr));
        pushButton_1->setText(QApplication::translate("erster_schritt", "1", nullptr));
        pushButton->setText(QApplication::translate("erster_schritt", "*", nullptr));
        pushButton_5->setText(QApplication::translate("erster_schritt", "5", nullptr));
        pushButton_0->setText(QApplication::translate("erster_schritt", "0", nullptr));
        pushButton_Korrektur->setText(QApplication::translate("erster_schritt", "Korrektur", nullptr));
        pushButton_3->setText(QApplication::translate("erster_schritt", "3", nullptr));
        pushButton_Abbruch->setText(QApplication::translate("erster_schritt", "Abbruch", nullptr));
        pushButton_2->setText(QApplication::translate("erster_schritt", "2", nullptr));
        pushButton_r->setText(QApplication::translate("erster_schritt", "#", nullptr));
        pushButton_hilfe->setText(QApplication::translate("erster_schritt", "Hilfe", nullptr));
        pushButton_Bestaetigung->setText(QApplication::translate("erster_schritt", "Best\303\244tigen", nullptr));
        Karte_3->setText(QApplication::translate("erster_schritt", "Karte 3", nullptr));
        Karte_2->setText(QApplication::translate("erster_schritt", "Karte 2", nullptr));
        Karte_1->setText(QApplication::translate("erster_schritt", "Karte 1", nullptr));
        Kartenleser->setText(QApplication::translate("erster_schritt", "______________________________________", nullptr));
        ausgabe->setText(QApplication::translate("erster_schritt", "Bitte Schieben Sie Ihre Karte ein!", nullptr));
        pushButton_Einzahlung->setText(QApplication::translate("erster_schritt", "Einzahlung", nullptr));
        pushButton_Auszahlung->setText(QApplication::translate("erster_schritt", "Auszahlung", nullptr));
        pushButton_Kontostand->setText(QApplication::translate("erster_schritt", "Kontostand", nullptr));
        pushButton_PIN_aendern->setText(QApplication::translate("erster_schritt", "PIN \303\204ndern", nullptr));
        fuenf->setText(QString());
        zehner->setText(QString());
        zwanny->setText(QString());
        fuffy->setText(QString());
        pushButton_10->setText(QApplication::translate("erster_schritt", "Ich bin ein Geldfach", nullptr));
        HILFE_BUTTON->setText(QApplication::translate("erster_schritt", "?", nullptr));
        Auszahlung_5->setText(QApplication::translate("erster_schritt", "5 \342\202\254", nullptr));
        Auszahlung_50->setText(QApplication::translate("erster_schritt", "50 \342\202\254", nullptr));
        Auszahlung_10->setText(QApplication::translate("erster_schritt", "10 \342\202\254", nullptr));
        Auszahlung_20->setText(QApplication::translate("erster_schritt", "20 \342\202\254", nullptr));
        Auszahlung_100->setText(QApplication::translate("erster_schritt", "100 \342\202\254", nullptr));
        Auszahlung_200->setText(QApplication::translate("erster_schritt", "200 \342\202\254", nullptr));
        Auszahlung_500->setText(QApplication::translate("erster_schritt", "500 \342\202\254", nullptr));
        Auszahlung_andererBetrag->setText(QApplication::translate("erster_schritt", "Anderer Betrag", nullptr));
        Ausgabe_Einzahlungsbetrag->setText(QApplication::translate("erster_schritt", "0", nullptr));
    } // retranslateUi

};

namespace Ui {
    class erster_schritt: public Ui_erster_schritt {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ERSTER_SCHRITT_H
